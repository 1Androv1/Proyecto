...
export const TaskItemToDo = ({ tittle, onDelete, onEditId }) => {
    const { setEditDialog } = useContext(contextProp)
    ...
    return (
        <div className={`flex w-full justify-center items-center flex-row ${disappear ? 'fade-out' : ''}`}>
            ...
            <div className='w-11/12 contenedor-opacidad rounded-md'>
                <div className='flex w-full h-full flex-row p-1'>
                    ...
                    <div className="flex justify-end gap-2 items-center pl-2 pr-2">
                        <button onClick={handleEditItem} className="h-full w-4 flex items-center justify-center p-0 mr-0 outline-none border-none bg-transparent focus:outline-none" style={{ overflow: 'visible' }}>
                        ...
                        <button onClick={handleEraseItem} className="h-full w-4 flex items-center justify-center p-0 mr-0 outline-none border-none bg-transparent focus:outline-none" style={{ overflow: 'visible' }}>
